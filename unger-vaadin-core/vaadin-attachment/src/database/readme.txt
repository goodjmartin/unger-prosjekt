Kopi av MaterialClassPanel jeg skrev om for å teste vedlegg ligger nedenfor, mes-material-api trenger også
en dependency på mes-attachment for å kunne testes.

Tabellene jeg opprettet ligger i tables.sql i denne mappen.
------------------------------------------------------------------------------------------------------------------------
...
import no.goodtech.mes.attachment.ui.AttachmentPanel;
