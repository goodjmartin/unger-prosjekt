 ...
 *      algorithm</a>
 */
public class ProperRamerDouglasPeucker {
	 ...
	 *             when {@code epsilon <= 0}
	 */
	public ProperRamerDouglasPeucker(double epsilon) {
		if (epsilon <= 0) {
	...
	public static void main(String[] args) {
		double epsilon = 0.16;
		ProperRamerDouglasPeucker rdp = new ProperRamerDouglasPeucker(epsilon);
